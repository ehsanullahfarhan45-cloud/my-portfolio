import{_isFirebaseServerApp as I,_getProvider as Kt,getApp as qn,SDK_VERSION as he,_registerComponent as Tt,registerVersion as wt}from"./firebase-app-BaAfWXYl.js";import{K as te,l as ne,J,r as h,k as Be,v as Xe,H as Gn,p as $t,n as zn,t as v,y as Kn,x as $n,f as Bn,F as Qe,b as Ze,e as jn,L as Bt,A as Yn,B as Jn,u as Xn,w as Qn,C as yt,i as Zn}from"./firebase-shared-V5nuO_2w.js";import"./vendor-Czj61bjO.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sr(n){switch(n){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function or(n){const e=te(ne(n)).link,t=e?te(ne(e)).deep_link_id:null,i=te(ne(n)).deep_link_id;return(i?te(ne(i)).link:null)||i||t||e||n}class ge{constructor(e){const t=te(ne(e)),i=t.apiKey??null,r=t.oobCode??null,s=sr(t.mode??null);u(i&&r&&s,"argument-error"),this.apiKey=i,this.operation=s,this.code=r,this.continueUrl=t.continueUrl??null,this.languageCode=t.lang??null,this.tenantId=t.tenantId??null}static parseLink(e){const t=or(e);try{return new ge(t)}catch{return null}}}function ro(n){return ge.parseLink(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oo(n,e){const t=h(n);await Le(!0,t,e);const{providerUserInfo:i}=await hi(t.auth,{idToken:await t.getIdToken(),deleteProvider:[e]}),r=Tn(i||[]);return t.providerData=t.providerData.filter(s=>r.has(s.providerId)),r.has("phone")||(t.phoneNumber=null),await t.auth._persistUserIfCurrent(t),t}async function ot(n,e,t=!1){const i=await O(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return A._forOperation(n,"link",i)}async function Le(n,e,t){await ce(e);const i=Tn(e.providerData),r=n===!1?"provider-already-linked":"no-such-provider";u(i.has(t)===n,e.auth,r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ao(n,e){if(I(n.app))return Promise.reject(T(n));const t=_(n),i=await dr(t,{token:e,returnSecureToken:!0}),r=await A._fromIdTokenResponse(t,"signIn",i);return await t._updateCurrentUser(r.user),r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lt(n){const e=_(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function co(n,e,t){const i=_(n),r={requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"};t&&De(i,r,t),await H(i,r,"getOobCode",Yi,"EMAIL_PASSWORD_PROVIDER")}async function uo(n,e,t){await In(h(n),{oobCode:e,newPassword:t}).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&lt(n),i})}async function lo(n,e){await $i(h(n),{oobCode:e})}async function hr(n,e){const t=h(n),i=await In(t,{oobCode:e}),r=i.requestType;switch(u(r,t,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":u(i.newEmail,t,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":u(i.mfaInfo,t,"internal-error");default:u(i.email,t,"internal-error")}let s=null;return i.mfaInfo&&(s=Ie._fromServerResponse(_(t),i.mfaInfo)),{data:{email:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.newEmail:i.email)||null,previousEmail:(i.requestType==="VERIFY_AND_CHANGE_EMAIL"?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}async function ho(n,e){const{data:t}=await hr(h(n),e);return t.email}async function fo(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=_(n),o=await H(i,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",_n,"EMAIL_PASSWORD_PROVIDER").catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&lt(n),c}),a=await A._fromIdTokenResponse(i,"signIn",o);return await i._updateCurrentUser(a.user),a}function po(n,e,t){return I(n.app)?Promise.reject(T(n)):at(h(n),G.credential(e,t)).catch(async i=>{throw i.code==="auth/password-does-not-meet-requirements"&&lt(n),i})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mo(n,e,t){const i=_(n),r={requestType:"EMAIL_SIGNIN",email:e,clientType:"CLIENT_TYPE_WEB"};function s(o,a){u(a.handleCodeInApp,i,"argument-error"),a&&De(i,o,a)}s(r,t),await H(i,r,"getOobCode",Ji,"EMAIL_PASSWORD_PROVIDER")}function go(n,e){const t=ge.parseLink(e);return(t==null?void 0:t.operation)==="EMAIL_SIGNIN"}async function Io(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=h(n),r=G.credentialWithLink(e,t||ae());return u(r._tenantId===(i.tenantId||null),i,"tenant-id-mismatch"),at(i,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _o(n,e){const t=nt()?ae():"http://localhost",i={identifier:e,continueUri:t},{signinMethods:r}=await fr(h(n),i);return r||[]}async function Eo(n,e){const t=h(n),r={requestType:"VERIFY_EMAIL",idToken:await n.getIdToken()};e&&De(t.auth,r,e);const{email:s}=await ji(t.auth,r);s!==n.email&&await n.reload()}async function To(n,e,t){const i=h(n),s={requestType:"VERIFY_AND_CHANGE_EMAIL",idToken:await n.getIdToken(),newEmail:e};t&&De(i.auth,s,t);const{email:o}=await Xi(i.auth,s);o!==n.email&&await n.reload()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mr(n){var r,s;if(!n)return null;const{providerId:e}=n,t=n.rawUserInfo?JSON.parse(n.rawUserInfo):{},i=n.isNewUser||n.kind==="identitytoolkit#SignupNewUserResponse";if(!e&&(n!=null&&n.idToken)){const o=(s=(r=Oe(n.idToken))==null?void 0:r.firebase)==null?void 0:s.sign_in_provider;if(o){const a=o!=="anonymous"&&o!=="custom"?o:null;return new j(i,a)}}if(!e)return null;switch(e){case"facebook.com":return new gr(i,t);case"github.com":return new Ir(i,t);case"google.com":return new _r(i,t);case"twitter.com":return new Er(i,t,n.screenName||null);case"custom":case"anonymous":return new j(i,null);default:return new j(i,e,t)}}class j{constructor(e,t,i={}){this.isNewUser=e,this.providerId=t,this.profile=i}}class An extends j{constructor(e,t,i,r){super(e,t,i),this.username=r}}class gr extends j{constructor(e,t){super(e,"facebook.com",t)}}class Ir extends An{constructor(e,t){super(e,"github.com",t,typeof(t==null?void 0:t.login)=="string"?t==null?void 0:t.login:null)}}class _r extends j{constructor(e,t){super(e,"google.com",t)}}class Er extends An{constructor(e,t,i){super(e,"twitter.com",t,i)}}function Ao(n){const{user:e,_tokenResponse:t}=n;return e.isAnonymous&&!t?{providerId:null,isNewUser:!1,profile:null}:mr(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ro(n,e){return h(n).setPersistence(e)}function Po(n){return mn(n)}async function So(n,e){return _(n).validatePassword(e)}function Tr(n,e,t,i){return h(n).onIdTokenChanged(e,t,i)}function wr(n,e,t){return h(n).beforeAuthStateChanged(e,t)}function ko(n,e,t,i){return h(n).onAuthStateChanged(e,t,i)}function No(n){h(n).useDeviceLanguage()}function Co(n,e){return h(n).updateCurrentUser(e)}function Oo(n){return h(n).signOut()}function bo(n,e){return _(n).revokeAccessToken(e)}async function Lo(n){return h(n).delete()}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ko(n,e,t){return rs(n,e,t)}async function rs(n,e,t){if(I(n.app))return Promise.reject(T(n));const i=_(n);X(n,e,D),await i._initializationPromise;const r=z(i,t);return await gt(r,i),r._openRedirect(i,e,"signInViaRedirect")}function $o(n,e,t){return ss(n,e,t)}async function ss(n,e,t){const i=h(n);if(X(i.auth,e,D),I(i.auth.app))return Promise.reject(T(i.auth));await i.auth._initializationPromise;const r=z(i.auth,t);await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"reauthViaRedirect",s)}function Bo(n,e,t){return os(n,e,t)}async function os(n,e,t){const i=h(n);X(i.auth,e,D),await i.auth._initializationPromise;const r=z(i.auth,t);await Le(!1,i,e.providerId),await gt(r,i.auth);const s=await Vn(i);return r._openRedirect(i.auth,e,"linkViaRedirect",s)}async function jo(n,e){return await _(n)._initializationPromise,Un(n,e,!1)}async function Un(n,e,t=!1){if(I(n.app))return Promise.reject(T(n));const i=_(n),r=z(i,e),o=await new ts(i,r,t).execute();return o&&!t&&(delete o.user._redirectEventId,await i._persistUserIfCurrent(o.user),await i._setRedirectUser(null,e)),o}async function Vn(n){const e=Ue(`${n.uid}:::`);return n._redirectEventId=e,await n.auth._setRedirectUser(n),await n.auth._persistUserIfCurrent(n),e}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ws(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function qs(n){Tt(new yt("auth",(e,{options:t})=>{const i=e.getProvider("app").getImmediate(),r=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:a}=i.options;u(o&&!o.includes(":"),"invalid-api-key",{appName:i.name});const c={apiKey:o,authDomain:a,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:hn(n)},l=new Pi(i,r,s,c);return Hi(l,t),l},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,i)=>{e.getProvider("auth-internal").initialize()})),Tt(new yt("auth-internal",e=>{const t=_(e.getProvider("auth").getImmediate());return(i=>new Hs(i))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),wt(qt,Gt,Ws(n)),wt(qt,Gt,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gs=5*60,zs=$t("authIdTokenMaxAge")||Gs;let zt=null;const Ks=n=>async e=>{const t=e&&await e.getIdTokenResult(),i=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(i&&i>zs)return;const r=t==null?void 0:t.token;zt!==r&&(zt=r,await fetch(n,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function Yo(n=qn()){const e=Kt(n,"auth");if(e.isInitialized())return e.getImmediate();const t=xi(n,{popupRedirectResolver:Vs,persistence:[Wr,kr,Nn]}),i=$t("authTokenSyncURL");if(i&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(i,location.origin);if(location.origin===s.origin){const o=Ks(s.toString());wr(t,o,()=>o(t.currentUser)),Tr(t,a=>o(a))}}const r=zn("auth");return r&&Wi(t,`http://${r}`),t}function $s(){var n;return((n=document.getElementsByTagName("head"))==null?void 0:n[0])??document}Si({loadJS(n){return new Promise((e,t)=>{const i=document.createElement("script");i.setAttribute("src",n),i.onload=e,i.onerror=r=>{const s=w("internal-error");s.customData=r,t(s)},i.type="text/javascript",i.charset="UTF-8",$s().appendChild(i)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});qs("Browser");export{eo as ActionCodeOperation,ge as ActionCodeURL,me as AuthCredential,no as AuthErrorCodes,ue as EmailAuthCredential,G as EmailAuthProvider,U as FacebookAuthProvider,Js as FactorId,F as GithubAuthProvider,V as GoogleAuthProvider,b as OAuthCredential,ve as OAuthProvider,Zs as OperationType,q as PhoneAuthCredential,Y as PhoneAuthProvider,Fs as PhoneMultiFactorGenerator,Xs as ProviderId,Vo as RecaptchaVerifier,Ye as SAMLAuthProvider,Qs as SignInMethod,xs as TotpMultiFactorGenerator,_t as TotpSecret,x as TwitterAuthProvider,lo as applyActionCode,wr as beforeAuthStateChanged,Uo as browserCookiePersistence,kr as browserLocalPersistence,Vs as browserPopupRedirectResolver,Nn as browserSessionPersistence,hr as checkActionCode,uo as confirmPasswordReset,Wi as connectAuthEmulator,fo as createUserWithEmailAndPassword,to as debugErrorMap,Lo as deleteUser,_o as fetchSignInMethodsForEmail,Ao as getAdditionalUserInfo,Yo as getAuth,io as getIdToken,fi as getIdTokenResult,Do as getMultiFactorResolver,jo as getRedirectResult,kt as inMemoryPersistence,Wr as indexedDBLocalPersistence,xi as initializeAuth,Po as initializeRecaptchaConfig,go as isSignInWithEmailLink,ur as linkWithCredential,xo as linkWithPhoneNumber,zo as linkWithPopup,Bo as linkWithRedirect,Mo as multiFactor,ko as onAuthStateChanged,Tr as onIdTokenChanged,ro as parseActionCodeURL,ti as prodErrorMap,lr as reauthenticateWithCredential,Ho as reauthenticateWithPhoneNumber,Go as reauthenticateWithPopup,$o as reauthenticateWithRedirect,gi as reload,bo as revokeAccessToken,Eo as sendEmailVerification,co as sendPasswordResetEmail,mo as sendSignInLinkToEmail,Ro as setPersistence,so as signInAnonymously,at as signInWithCredential,ao as signInWithCustomToken,po as signInWithEmailAndPassword,Io as signInWithEmailLink,Fo as signInWithPhoneNumber,qo as signInWithPopup,Ko as signInWithRedirect,Oo as signOut,oo as unlink,Co as updateCurrentUser,yo as updateEmail,vo as updatePassword,Wo as updatePhoneNumber,wo as updateProfile,No as useDeviceLanguage,So as validatePassword,To as verifyBeforeUpdateEmail,ho as verifyPasswordResetCode};
